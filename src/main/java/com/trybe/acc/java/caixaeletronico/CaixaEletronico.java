...
public class CaixaEletronico {
  ...
  public static void main(String[] args) {
    ...
    Conta contaPoupancaCliente1 = new Conta("Poupança", pessoaCliente1, banco);
    Conta contaCorrenteCliente1 = new Conta("Corrente", pessoaCliente1, banco);
    pessoaCliente1.adicionarConta(contaPoupancaCliente1);
    pessoaCliente1.adicionarConta(contaCorrenteCliente1);

    // pessoa cliente 2
    PessoaCliente pessoaCliente2 = banco.adicionarPessoaCliente("Abadiania Silva", "848.725.510-87", "1234");
    Conta contaPoupancaCliente2 = new Conta("Poupança", pessoaCliente2, banco);
    Conta contaCorrenteCliente2 = new Conta("Corrente", pessoaCliente2, banco);
    pessoaCliente2.adicionarConta(contaPoupancaCliente2);
    pessoaCliente2.adicionarConta(contaCorrenteCliente2);


    // pessoa cliente 3
    PessoaCliente pessoaCliente3 = banco.adicionarPessoaCliente("Camaragibe Oliveira", "433.892.200-11", "1234");
    Conta contaPoupancaCliente3 = new Conta("Poupança", pessoaCliente3, banco);
    Conta contaCorrenteCliente3 = new Conta("Corrente", pessoaCliente3, banco);
    pessoaCliente3.adicionarConta(contaPoupancaCliente3);
    pessoaCliente3.adicionarConta(contaCorrenteCliente3);
    // laco infinito
    while (true) {
